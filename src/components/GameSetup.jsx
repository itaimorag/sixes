...
export function GameSetup({ roomId, onGameStart }) {
        ...
        <div className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <Input placeholder="Enter player name" value={playerName} onChange={(e) => setPlayerName(e.target.value)} onKeyDown={(e) => e.key === "Enter" && handleAddPlayer()}/>
